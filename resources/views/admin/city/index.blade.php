...
@section('content')
    ...
    <div class="card card-custom my-4 border-0 shadow-sm">
        <div class="card-header bg-light d-flex flex-wrap justify-content-between align-items-center">
            <h5 class="mb-3 md:mb-0">City List</h5>
            <!-- Search Box -->
            ...
            <!-- Create Button -->
            <a href="{{ route('cities.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Create
                City</a>
        </div>
                ...
                <tbody>
                    @foreach ($cities as $city)
                        <tr>
                            ...
                            <td>{{ $city->name }}</td>
                            <td>
                                <a href="{{ route('cities.edit', $city->id) }}" class="btn btn-sm btn-info"><i
